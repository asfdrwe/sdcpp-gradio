...
def generate(prompt, resolution):
    rating = "general"
...
#        '-n', "bad quality, worst quality", 
        '-n', "bad quality, worst quality, nsfw", 
        '-o', filename
        ]
    subprocess.run(args)
...
def main():
    ...
    app = gradio.Interface(fn = generate, title = "日本語画像生成", inputs = [prompt, resolution], outputs = "image", submit_btn = "生成", clear_btn = None, flagging_mode = "never")
